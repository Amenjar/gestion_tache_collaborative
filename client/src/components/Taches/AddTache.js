...
function AddTache() {
  ...
  const [piece_joint,setPiece]=useState("");
    ...
    >
      ...
      <Button variant="contained"  style={{width:"200px",marginLeft:"10px",backgroundColor:"#001f3f",color:"white"}} onClick={()=>dispatch(addtache({titre,description,date_fin,prop,priori,etat,piece_joint},Navigate))}>Add Tache</Button>
    </Box>
